...
NEW_POST_DATE_PATH_FORMAT = '%Y-%m-%d %H:%M'
...
# NOTE: Sections feature has been removed in Nikola; use categories instead.
# POSTS_SECTIONS = True
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-111342564-2"></script>
<script>
