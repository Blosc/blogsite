...
Finally, as mentioned in the `Blosc2 NDim`_ post, if you need help in `finding the best parameters <https://blosc.org/btune>`_ for your use case, feel free to reach out to the Blosc team at `contact (at) blosc.org`.
