...
* **Small overhead on non-compressible data**: only a maximum of (16
  + 4 * nthreads_used) additional bytes over the source buffer length
...
<synthetic-benchmarks.html>`_, and I'm happy to say that, since 0.9.5 on,
...
strides for becoming a great utility.  Try it out now!
